...
from app.utils import open_handover_map, validation_error_response
...
def list_sheds():
    ...
    try:
        ...
        opens = open_handover_map(db)
        for shed in rows:
            shed.open_handover = opens.get(shed.id)
